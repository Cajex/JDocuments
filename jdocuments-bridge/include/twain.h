...
//Panasonic capabilities:

/**************************************************************************************
Contents		:	Allows to discard the blank page.
ValueType		:	TW_INT32
AllowedValue	:	TWBP_DISABLE -2
					TWBP_AUTO	 -1
**************************************************************************************/
#define PCAP_AUTOSKIPBLANKPAGES		0x8216

/**************************************************************************************
Contents		:	Setting for the pixel ratio in image.
ValueType		:	TW_INT32
DefaultValue	:	20(0.2%��
AllowedValue	:	1-500(0.01%-5.00%)
**************************************************************************************/
#define PCAP_AUTOSKIPBLANKPAGES_THRESHOLD		0x8217

/**************************************************************************************
Contents		:	The user can set the error message option to be TRUE or FALSE.
					If TRUE, the Source does not display the error dialog box anytime.
					(This CAP is valid in state 4-7.)
ValueType		:	TW_BOOL
DefaultValue	:	FALSE
AllowedValue	:	TRUE/FALSE
Others			:	Setting of this CAP is given priority to over CAP_SHOWERRMSG��s setting.
**************************************************************************************/
#define PCAP_HIDEERRDIALOG			0x8140

/**************************************************************************************
Contents		:	The user can set the error message option to be TRUE or FALSE.
					If TRUE, the Source display the error dialog box if error happen.
					(This CAP��s setting is valid in state 6-7)
ValueType		:	TW_BOOL
DefauleValue	:	TRUE
AllowedValue	:	TRUE/FALSE
Others			:	If PCAP_HIDEERRDIALOG is TRUE, this CAP��s setting is ignored.
**************************************************************************************/
#define PCAP_SHOWERRMSG				0x8125

/**************************************************************************************
Contents		:	This function detects when two or more documents are scaned at the same time.
ValueType		:	TW_BOOL
DefauleValue	:	TRUE
AllowedValue	:	TRUE/FALSE
Others			:	When CAP_DETECTABNORMALFEED is TRUE, this capability is Invalid.
**************************************************************************************/
#define PCAP_DOUBLEFEEDDETECTION	0x812b

/**************************************************************************************
Contents		:	Select the sensitivity level of double feed detection.
ValueType		:	TW_UINT16
DefauleValue	:	TWDFS_NORMAL
AllowedValue	:	TWDFS_LOW 0 Low Sensitivity
					TWDFS_NORMAL 1 Normal Sensitivity
					TWDFS_HIGH 2 High Sensitivity
Others			:	This function is valid only when CAP_DOUBLEFEEDDETECTION is TRUE.
**************************************************************************************/
#define PCAP_DOUBLEFEEDDETECTION_SENSITIVITY	0x8137

/**************************************************************************************
Contents		:	Select the operation in the event that double feed has been detected.
ValueType		:	TW_UINT16
DefauleValue	:	TWDFA_STOPSCAN
AllowedValue	:	TWDFA_BEEP 0 Beep
					TWDFA_STOPSCAN 1 Stop
					TWDFA_ABORT 2 Abort
Others			:	This function is valid only when CAP_DOUBLEFEEDDETECTION is TRUE.
**************************************************************************************/
#define PCAP_DOUBLEFEEDDETECTION_ACTION			0x8138

/**************************************************************************************
Contents		:	TRUE enables the auto rotate function.FALSE disables the auto rotate function.
ValueType		:	TW_BOOL
DefauleValue	:	FALSE
AllowedValue	:	TRUE/FALSE
Others			:	If the Automatic Image Orientation function is unsupported, return TWRC_FAILER/TWCC_CAPUNSUPPORTED.
**************************************************************************************/
#define PCAP_AUTOROTATE				0x8230

/**************************************************************************************
Contents		:	This function set the language for auto rotate function.
ValueType		:	TW_UINT16
DefauleValue	:	TWAR_LG_DEPEND
AllowedValue	:	TWAR_LG_DEPEND 0	TWAR_LG_ENGLISH 1	TWAR_LG_JAPANESE 2	TWAR_LG_GERMAN 3	TWAR_LG_SPANISH 4
					TWAR_LG_FRENCH 5	TWAR_LG_ITALIAN 6	TWAR_LG_SCHINESE 7	TWAR_LG_RUSSIAN 8	TWAR_LG_TCHINESE 9
					TWAR_LG_PORTUGUESE_BR 10	TWAR_LG_KOREAN 11	TWAR_LG_TURKISH 12	TWAR_LG_POLAND 13	TWAR_LG_PORTUGUESE_PT 14
					TWAR_LG_SWEDISH 15	TWAR_LG_DANISH 16	TWAR_LG_DUTCH 17
Others			:	If the Automatic Image Orientation function is unsupported, return TWRC_FAILER/TWCC_CAPUNSUPPORTED.
**************************************************************************************/
#define PCAP_AUTOROTATE_LANGUAGE	0x8231

/**************************************************************************************
Contents		:	Selection for feed speed when a document is being scanned.
ValueType		:	TW_UINT16
DefauleValue	:	TWFS_NORMAL
AllowedValue	:	TWFS_NORMAL 1
					TWFS_LOW	0
					TWFS_HIGH	2
Others			:	Either CAP_FEEDERENABLED or CAP_AUTOFEEDERSELECT must be TRUE to use this capability.
**************************************************************************************/
#define PCAP_FEEDINGSPEED				0x812c

//Kodak Capabilities:
/**************************************************************************************
Contents		:	Defines which edge of the ��paper�� the image��s ��top�� is aligned with.
ValueType		:	TW_UINT16
DefauleValue	:	TWOR_PORTRAIT
AllowedValue	:	TWOR_ROT0
					TWOR_ROT90
					TWOR_ROT180
					TWOR_ROT270
					TWOR_PORTRAIT (equals TWOR_ROT0)
					TWOR_LANDSCAPE (equals TWOR_ROT270)
Others			:	The Source is responsible for rotating the image if it allows this capability to be set.
					If not supported, return TWRC_FAILURE / TWCC_CAPUNSUPPORTED.
**************************************************************************************/
#define KCAP_ORIENTATION				0x80D5
...
#define KCAP_DOUBLEFEEDDETECTION	0x103F				/*Added by litong*/
#define CCAP_DOUBLEFEEDDETECTION	0x8040				/*Added by litong,supported by canon*/
...
//new add by zxl start
#define CAP_SHOWERRMSG      0x8125
#define CAP_HIDEERRDIALOG   0x8140
//#define CCAP_QUIETERRORS    0x88F2
#define CCAP_QUIETERRORS		CAP_CUSTOMBASE + 0x0100
//#define CCAP_QUIET_NOPAGEDIALOG 0x8101
